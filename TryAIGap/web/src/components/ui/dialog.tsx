      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-lg p-1 text-muted-foreground opacity-70 transition-all hover:bg-muted hover:opacity-100 hover:text-foreground focus:outline-hidden disabled:pointer-events-none [&_svg]:size-4"
          >
            <XIcon />
